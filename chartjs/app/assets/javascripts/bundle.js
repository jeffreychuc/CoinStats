...
var _autoCompleteMin = __webpack_require__(175);

var _autoCompleteMin2 = _interopRequireDefault(_autoCompleteMin);
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var apiUrl = 'https://api.coinmarketcap.com/v1/ticker/?start=1&limit=100';

  var hitApi = function hitApi() {
    return $.ajax({
      url: apiUrl,
      method: 'GET',
      dataType: "JSON"
  ...
  var jsIsDumb = function jsIsDumb(a, b) {
    if (a > b) {
      return -1;
    }
    return 1;
  ...
  var graphGenerateWrapper = function graphGenerateWrapper(data) {
  ...
  var generateGraph = function generateGraph() {
    ...
    hitApi().then(function (data) {
      ...
      return graphGenerateWrapper(data);
    });
  };
