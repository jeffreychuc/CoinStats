...
var _chart = __webpack_require__(297);

var _chart2 = _interopRequireDefault(_chart);

var _api_util = __webpack_require__(346);

var _news = __webpack_require__(347);
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var formatData = function formatData(apiData, key) {
    var matchedData = apiData.map(function (coin) {
      return _defineProperty({}, coin.id, coin[key]);
    });
    matchedData = matchedData.sort(function (a, b) {
      return Object.values(b)[0] - Object.values(a)[0];
    });
    var coinList = matchedData.map(function (coin) {
      return Object.keys(coin)[0];
    });
    var dataSets = { label: key,
  ...
  var graphGenerateWrapper = function graphGenerateWrapper(data, graphType, options) {
    var myChart = function myChart(input) {
  ...
  var generateGraph = function generateGraph(data) {
    ...
    var sliceData = document.getElementById('numberOfCoins').value;
    if (isNaN(parseInt(sliceData))) {
      sliceData = 10;
    }

    var legend = ['price', 'price_btc', '24h_volume_usd', 'market_cap', 'percent_change_1h', 'percent_change_24h', 'percent_change_7d'];
    var key = parseInt(document.getElementById('dataToDisplay').value);
    if (key === 0 || key === 3) {
    ...
    var formattedData = formatData(data.slice(0, sliceData), key);
  ...
  document.getElementById("buildGraph").addEventListener("click", function () {
    ...
    var aligner = document.getElementsByClassName('aligner')[0].classList.add('dataDisplay');
  ...
  document.getElementsByClassName('headerLogo')[0].addEventListener('click', function () {
    if (this.classList.value.includes('headerDataPresent')) {
      ...
      var aligner = document.getElementsByClassName('aligner')[0].classList.remove('dataDisplay');
...
Chart.Interaction = __webpack_require__(98);
Chart.platform = __webpack_require__(99);
...
var defaults = __webpack_require__(3);
var helpers = __webpack_require__(2);
var Interaction = __webpack_require__(98);
var platform = __webpack_require__(99);
